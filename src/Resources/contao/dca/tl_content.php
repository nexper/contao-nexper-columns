...
$GLOBALS['TL_DCA']['tl_content']['palettes']['nx_row_start'] = '{type_legend},type;{nx_row_legend},nx_row_no_padding,nx_row_equal_height;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
$GLOBALS['TL_DCA']['tl_content']['subpalettes']['nx_row_equal_height'] = 'nx_row_vertical_center';
...
$GLOBALS['TL_DCA']['tl_content']['fields']['nx_row_equal_height'] = array(
    'inputType' => 'checkbox',
    'label' => &$GLOBALS['TL_LANG']['tl_content']['nx_row_equal_height'],
...
// nx_column_start
if(isset($GLOBALS['TL_CONFIG']['nxColumnsFramework']) && $GLOBALS['TL_CONFIG']['nxColumnsFramework'] === 'bootstrap-4') {
    $GLOBALS['TL_DCA']['tl_content']['palettes']['nx_column_start'] = '{type_legend},type,headline;{nx_columns_legend},nx_columns_selection,nx_columns_xs,nx_columns_sm,nx_columns_md,nx_columns_lg,nx_columns_xl;{nx_columns_offset_legend},nx_columns_offset_xs,nx_columns_offset_sm,nx_columns_offset_md,nx_columns_offset_lg,nx_columns_offset_xl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
} else {
    $GLOBALS['TL_DCA']['tl_content']['palettes']['nx_column_start'] = '{type_legend},type,headline;{nx_columns_legend},nx_columns_selection,nx_columns_xs,nx_columns_sm,nx_columns_md,nx_columns_lg;{nx_columns_offset_legend},nx_columns_offset_xs,nx_columns_offset_sm,nx_columns_offset_md,nx_columns_offset_lg;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
}

$GLOBALS['TL_DCA']['tl_content']['fields']['nx_columns_selection'] = array(
    'inputType' => 'checkbox',
    'label' => &$GLOBALS['TL_LANG']['tl_content']['nx_columns_selection'],
    'options' => $GLOBALS['TL_LANG']['tl_content']['nx_columns_selection'][$GLOBALS['TL_CONFIG']['nxColumnsFramework']],
...
$GLOBALS['TL_DCA']['tl_content']['fields']['nx_columns_xs'] = array(
	...
	'eval' => array('mandatory' => true, 'tl_class' => Nexper\NexperColumns\Columns::getBackendClass()),
...
$GLOBALS['TL_DCA']['tl_content']['fields']['nx_columns_offset_xs'] = array(
    ...
    'options' => $GLOBALS['TL_LANG']['tl_content']['nx_columns_sizes'][$GLOBALS['TL_CONFIG']['nxColumnsFramework']],
	'eval' => array('includeBlankOption' => true, 'tl_class' => Nexper\NexperColumns\Columns::getBackendClass()),
    'sql' => "char(2) NOT NULL default ''",
);
